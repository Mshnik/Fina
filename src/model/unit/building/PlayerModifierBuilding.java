...
public final class PlayerModifierBuilding extends Building {
   ...
   */
  PlayerModifierBuilding(Player owner, String name, String imageFilename, int level, int manaCost,
  ...
  public Unit clone(Player owner, Tile location) {
    return new PlayerModifierBuilding(owner, name, getImgFilename(), level, manaCost, manaCostScaling, location, getStats());
  }
}
