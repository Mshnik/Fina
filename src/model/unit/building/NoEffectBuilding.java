...
public final class NoEffectBuilding extends Building {
   ...
   */
  NoEffectBuilding(Player owner, String name, String imageFilename, int level, int manaCost,
  ...
  public Unit clone(Player owner, Tile location) {
    return new NoEffectBuilding(owner, name, getImgFilename(), level, manaCost, manaCostScaling, location, getStats());
  }
}
