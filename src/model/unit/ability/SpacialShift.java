...
public final class SpacialShift extends Ability {
   ...
   */
  SpacialShift(String name, int level, int manaCost, ExpandableCloud effectCloud, boolean canBeCloudBoosted, int castDist, List<Class<? extends Unit>> affectedUnitTypes, boolean appliesToAllied, boolean appliesToFoe, String description, List<AbilityEffect> effects) {
    super(name, level, manaCost, effectCloud, canBeCloudBoosted, castDist, affectedUnitTypes, appliesToAllied, appliesToFoe, description, effects);
  }
