...
/** An instance represents and draws the path on the model.board when
 * the player is moving a model.unit
 * @author MPatashnik
 *
 */
public class PathSelector extends LocationSelector implements Paintable, Iterable<Tile>{
	...
	/** Return the total cost of traveling the given path for model.unit.
	 * Doesn't count the first tile - tile the model.unit is already on */
